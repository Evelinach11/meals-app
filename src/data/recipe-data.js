...
export const borch = {
  ...
  ingredients: [
    ...
    { name: "Картопля", count: 4, typeOfCount: "шт", calories: 85 },
    { name: "Буряк", count: 2, typeOfCount: "шт", calories: 45 },
    { name: "Морква", count: 2, typeOfCount: "шт", calories: 35 },
    { name: "Цибуля", count: 3, typeOfCount: "шт", calories: 43 },
    {
    ...
    { name: "Томатна паста", count: 2, typeOfCount: "ст. л", calories: 88800 },
    {
    ...
    { name: "Лавровий лист", count: 1, typeOfCount: "шт", calories: 374 },
